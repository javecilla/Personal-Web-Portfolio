<script setup lang="ts">
  ...
  const components = {
    ...
    TestimonialsSection: defineAsyncComponent(
      () => import('@/components/sections/testimonials/TestimonialsSection.vue')
    ),
    FAQSection: defineAsyncComponent(
      () => import('@/components/sections/faqs/FAQSection.vue')
    ),
  ...
  <main class="min-h-screen" :class="{ ready: layoutReady }">
    ...
    >
      <div v-show="isContentVisible">
        ...
        <PageTransition :is-loaded="isFullyLoaded" class="w-full">
          <NavBar />
