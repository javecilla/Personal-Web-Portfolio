...
<template>
  <div 
    class="group relative w-full h-full perspective-1000"
    @mousemove="handleMouseMove"
    @mouseenter="handleMouseEnter"
    @mouseleave="handleMouseLeave"
  >
    <div 
      class="relative w-full h-full transition-all duration-500 ease-out preserve-3d"
      :style="{
        transform: `
    ...
    >
      ...
      <img 
        :src="src" 
        :alt="alt" 
        class="w-full h-full object-cover object-center rounded-3xl transition-all duration-500"
        :class="{ 
      ...
      <div 
        ...
        :class="{
          'bg-gradient-to-br from-black/30 to-transparent opacity-100': isHovered,
          'bg-gradient-to-br from-black/20 to-transparent opacity-0': !isHovered
        }"
      ></div>
    </div>
  </div>
