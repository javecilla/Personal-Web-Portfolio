...
export const dataSets: DataSets[] = [
  ...
  },
  {
    ...
    answer:
      'Yes, I’m open to project commissions! I work with clients on a project-by-project basis to deliver custom web solutions. Whether it’s a small site or a large-scale application, feel free to reach out to discuss your requirements and get a personalized quote.',
  ...
  },
  {
    ...
    answer:
      'The cost depends on the project’s scope, complexity, and timeline. I offer competitive pricing and work closely with clients to ensure high-quality solutions fit their budget. Contact me for a detailed quote based on your needs!',
  ...
  },
  {
    ...
    answer:
      'Absolutely! I offer post-launch support and maintenance packages, including:\n- Bug fixes\n- Performance optimization\n- Security updates\n- Feature enhancements\nWe can tailor the terms to suit your project’s requirements.',
  ...
  },
  {
    ...
    answer:
      'Since May 2022, I’ve been an IT Assistant at Golden Minds Colleges, starting with UI/UX improvements and growing into backend development and system maintenance. My key experiences include:\n- Working on the college’s official website\n- Developing an online voting system\nThese projects blend technical skills with real-world impact.',
  ...
  },
  {
    ...
    answer:
      'I love working with Vue.js it’s intuitive, flexible, and pairs perfectly with TypeScript for building robust frontend applications. On the backend, Laravel’s elegance and powerful features make it a close second!',
  ...
  },
  {
    ...
    answer:
      'Yes, I’m experienced with MySQL and PostgreSQL. I design efficient database schemas, optimize queries, and integrate them seamlessly into web applications for reliable data management.',
  ...
  },
  {
    ...
    answer:
      'I’m a BSIT student at Bulacan State University (since 2023), specializing in web development. I also graduated from Golden Minds Colleges’ ICT track in 2023, where I started mastering programming basics and built my first projects.',
  ...
  },
  {
    ...
    answer:
      'Yes, I’ve worked on academic projects like voting systems and vocabulary apps. I can assist with web development tasks reach out with your project details, and let’s see how I can help!',
  ...
  },
  {
    ...
    answer:
      "I'm currently based in the Philippines, living and studying in Bulacan.",
  ...
  },
  {
    ...
    answer:
      "A **REST API** is a set of rules for building web services that allow systems to communicate over **HTTP**. I've implemented **RESTful APIs** using **Laravel**, following principles like **statelessness** and **resource-based endpoints**, to connect my frontend (**Vue.js**) with backend databases (**MySQL**, **PostgreSQL**) efficiently.",
  ...
  },
  {
    ...
    answer:
      "I'm currently working and continue enhancing the **Student Information Management System for Senior High School (SIMSSHS)**, a web application that helps manage student information and provides a platform for teachers to interact with students.",
    keywords: ['projects', 'portfolio', 'work', 'examples', 'creations'],
    patternSuggestions: [19, 4, 5],
    formatSuggestion: ['paragraph', 'sentence'],
    category: 'Services'
  },
  {
    ...
    answer:
      "I'm currently learning and mastering docker to expand my knowledge and skills in the field of web development and software engineering.",
    keywords: [
      'tech stacks',
      'tools',
      'learning',
  ...
  {
    id: 39,
    question: 'What software development methodology do you use?',
    answer:
      'I use the **Agile Methodology** for software development, which emphasizes iterative development, collaboration, and flexibility. This approach allows for continuous feedback and adaptation to changing requirements, ensuring that the final product meets the needs of the users and stakeholders.',
    keywords: [
      'methodology',
      'agile',
      'development',
  ...
  },
  {
    ...
    answer:
      'I follow a **Test-Driven Development (TDD)** approach, where I write tests before implementing the code. This ensures that the code meets the required specifications and helps catch issues early in the development process.',
